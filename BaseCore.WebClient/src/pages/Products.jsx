                            ...
                            <table className="ts-table">
                                <thead>
                                    <tr>
                                        ...
                                        {isAdmin() && <th className="ts-table-col-narrow text-right">Thao tác</th>}
                                    </tr>
                                </thead>
                                <tbody>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="max-h-[calc(90vh-140px)] overflow-y-auto p-5">
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    <label>
                                        <span className="mb-1 block text-sm font-semibold text-[var(--color-fg)]">Nhà cung cấp</span>
                                    ...
                                    <div className="md:col-span-2 rounded-md border border-[var(--color-border)] p-3">
                                        <div className="mb-3 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                                            ...
                                            <span className="text-xs font-semibold text-[var(--color-fg-muted)]">{specDefinitions.length} thông số</span>
                                        </div>
                                        {specDefinitions.length === 0 ? (
                                            <p className="mb-0 text-sm text-[var(--color-fg-muted)]">Danh mục này chưa có bộ thông số. Hãy cấu hình trong trang Danh mục trước.</p>
                                        ) : (
                                                        ...
                                                        <label key={definition.id}>
                                                            ...
                                                            {dataType === 'boolean' || dataType === 'bool' ? (
                                                                ...
                                                                <div className="grid gap-2">
                                                                    ...
                                                                    {allowCustomValue && (
                                                                        <input type="text" className={`${inputClass} w-full`} placeholder="Giá trị tùy chỉnh" value={rawValue ?? ''} onChange={(e) => setSpecValue({ value: e.target.value, specOptionId: '' })} />
                                                                    )}
                                                                </div>
                                                            ) : hasOptions ? (
                                                                <div className="grid gap-2">
                                                                    ...
                                                                    {allowCustomValue && (
                                                                        <input type="text" className={`${inputClass} w-full`} placeholder="Nhập giá trị khác nếu danh sách chưa có" value={currentOptionId ? '' : (rawValue ?? '')} onChange={(e) => setSpecValue({ value: e.target.value, specOptionId: '' })} />
                                                                    )}
                                                                </div>
                                                            ) : dataType === 'textarea' ? (

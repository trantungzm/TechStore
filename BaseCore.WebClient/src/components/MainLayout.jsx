...
const MainLayout = ({ children }) => {
    ...
    const handleNotificationClick = () => {
        if (hasNewTicketNotification && latestTicketTime) {
            localStorage.setItem(LAST_SEEN_TICKET_KEY, String(latestTicketTime));
    ...
    useEffect(() => {
        ...
        const loadNotifications = async () => {
            ...
            try {
                ...
                console.error('Failed to load ticket notification:', error);
            }
        };
    ...
    useEffect(() => {
        ...
        if (location.pathname === '/admin/tickets' && latestTicketTime) {
            localStorage.setItem(LAST_SEEN_TICKET_KEY, String(latestTicketTime));
            setHasNewTicketNotification(false);
        }
    }, [latestOrderTime, latestTicketTime, location.pathname]);
                    ...
                    <div className="flex h-14 items-center px-4 lg:px-8">
                        ...
                        <div className="ml-auto flex items-center gap-3">
                            ...
                            >
                                ...
                                {(hasNewOrderNotification || hasNewTicketNotification) && (

    ...
    public class AppDbContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { Id = 5, Name = "AirPods Pro", Price = 5990000, OriginalPrice = 6990000, Stock = 25, CategoryId = 7, Description = "Wireless earbuds", ImageUrl = "/electro/img/product-5.png", Brand = "Apple", IsBestSeller = true, IsDiscounted = true, RequiresSerialTracking = true }
            );
